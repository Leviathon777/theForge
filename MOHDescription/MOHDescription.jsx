...
//   user9,
//   user10,
// } from "../../img/nft-image-5.png";
import nft_image_5 from "../../img/nft-image-5.png";
...
const MOHDescription = ({ nft }) => {
  ...
  const historyArray = [user1, user2, user3, user4, user5];
  const provananceArray = [user6, user7, user8, user9, user10];
  const ownerArray = [user1, user8, user2, user6, user5];
      ...
      {currentItems.map((el, i) => (
        <div className={Style.MOHDescription_box}>
          ...
          <div className={Style.MOHDescription_box_share}>
            <p>{nft.category}</p>
            <div
              className={Style.MOHDescription_box_share_box}
            ...
            >
              ...
              {NFTMenu && (
                <div
                  className={Style.MOHDescription_box_share_box_social}
                  onMouseEnter={handleMouseEnter}
                  onMouseLeave={handleMouseLeave}
                >
                  <a href="#">
          ...
          <div className={Style.MOHDescription_box_profile}>
            ...
            <div className={Style.MOHDescription_box_profile_box}>
              ...
              <div className={Style.MOHDescription_box_profile_box_right}>
                ...
                <div
                  className={Style.MOHDescription_box_profile_box_right_info}
                >
            ...
            <div className={Style.MOHDescription_box_profile_biding}>
              <div className={Style.MOHDescription_box}></div>

              <div
                className={Style.MOHDescription_box_profile_biding_box_timer}
              >
                <div
                  className={
              ...
              <div
                className={Style.MOHDescription_box_profile_biding_box_price}
              >
                <div
                  className={
              ...
              <div
                className={Style.MOHDescription_box_profile_biding_box_button}
              >
              ...
              {history && (
                <div
                  className={Style.MOHDescription_box_profile_biding_box_card}
                >
