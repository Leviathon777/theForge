...
const WalkthroughModal = ({ isOpen, onRequestClose = false }) => {
    ...
    const newUserSteps = useMemo(() => [
        ...
        'Step 9: If you chose to proceed with the KYC process, please allow the allotted time for SUMSUB (our KYC provider) to complete and approve your KYC before attempting to invest as an ETERNAL.',
