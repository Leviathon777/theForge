...
const EntryPage = ({ onEnter, isModalVisible, handleAccept, handleDecline }) => {
  ...
  <div className={styles.cookieOverlay}>
    <div className={styles.cookieContent}>
      <h2 style={{ textAlign: "center" }}>We Respect Your Privacy</h2>
      ...
      <div className={styles.button_container_lower} style={{ textAlign: "center", marginTop: "20px" }}>
        ...
        <button onClick={handleManagePreferences} className="cookie-button manage">
          Manage Preferences
        </button>
      </div>
    </div>
