  ...
  return (
    <div className={styles.BtnBox_main}>
      <div className={styles.BtnBox}>
        ...
        {/* Telegram Button */}
        <a href={"https://www.xdrip.io"} target="_blank" rel="noopener noreferrer" title="Telegram">
          <button className={styles.Btn}>
            <span className={styles.svgContainer}>
        ...
        {/* Twitter Button */}
        <a href={"https://www.xdrip.io"} target="_blank" rel="noopener noreferrer" title="Twitter">
        ...
        {/* Instagram Button */}
        <a href={"https://www.xdrip.io"} target="_blank" rel="noopener noreferrer" title="Instagram">
        ...
        {/* TikTok Button */}
        <a href={"https://www.xdrip.io"} target="_blank" rel="noopener noreferrer" title="TikTok">
